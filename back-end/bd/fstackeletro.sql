...
REPLACE INTO `produtos` (`id`, `categoria`, `descricao`, `preco`, `preco_venda`, `imagem`)
...
UPDATE `fstackeletro`.`voltagem` SET `id_categoria` = '5' WHERE (`id_voltagem` = '5');
UPDATE `fstackeletro`.`voltagem` SET `id_categoria` = '6', `voltagem` = '110' WHERE (`id_voltagem` = '6');
UPDATE `fstackeletro`.`voltagem` SET `id_categoria` = '7' WHERE (`id_voltagem` = '7');
UPDATE `fstackeletro`.`voltagem` SET `id_categoria` = '8' WHERE (`id_voltagem` = '8');
UPDATE `fstackeletro`.`voltagem` SET `id_categoria` = '9' WHERE (`id_voltagem` = '9');
UPDATE `fstackeletro`.`voltagem` SET `id_categoria` = '10' WHERE (`id_voltagem` = '10');
UPDATE `fstackeletro`.`voltagem` SET `id_categoria` = '11' WHERE (`id_voltagem` = '11');
UPDATE `fstackeletro`.`voltagem` SET `id_categoria` = '12', `voltagem` = '220' WHERE (`id_voltagem` = '12');
